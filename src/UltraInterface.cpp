...
//	Camera::UltraStatus xhStatus;
//	m_cam.getStatus(xhStatus);
//	switch (xhStatus.state) {
//	case Camera::UltraStatus::Idle:
//		status.acq = AcqReady;
//		status.det = DetIdle;
//		std::cout << "Camera idle" << std::endl;
//		break;
//	case Camera::UltraStatus::PausedAtGroup:
//	case Camera::UltraStatus::PausedAtFrame:
//	case Camera::UltraStatus::PausedAtScan:
//		status.det = DetWaitForTrigger;
//		status.acq = AcqRunning;
//		std::cout << "Camera paused" << std::endl;
//		break;
//	case Camera::UltraStatus::Running:
//		status.det = DetExposure;
//		status.acq = AcqRunning;
//		std::cout << "Camera running" << std::endl;
//		break;
